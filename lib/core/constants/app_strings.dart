...
class AppStrings {
  ...
  static const String dashboardPageTitle = 'لوحة التحكم';
  ...
  static const String amountPaidHint = 'المبلغ المدفوع (ريال)';
  static const String settingsPageTitle = 'الإعدادات';
  static const String gigabytePriceHint = 'سعر الجيجابايت (ريال)';
